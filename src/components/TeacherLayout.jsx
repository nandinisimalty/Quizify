        ...
        <div className="p-4 border-t border-gray-200 shrink-0">
          <div className="flex items-center gap-3 px-3 py-3 mb-2 rounded-xl bg-gray-50">
            ...
            <div className="flex-1 truncate">
              <p className="text-sm font-semibold text-gray-900 truncate">{userData?.name || 'Teacher'}</p>
              <p className="text-xs text-gray-500 font-medium truncate">{userData?.post || 'Educator'}</p>
            </div>
          </div>
          <button
